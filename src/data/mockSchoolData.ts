...
export const schoolNavItems: SchoolNavItem[] = [
  ...
  { label: "Students", href: "/school/students", icon: UsersRound },
  { label: "Programs", href: "/school/programs", icon: BookOpenCheck },
  { label: "Enroll & Sessions", href: "/school/enrollments", icon: CalendarDays },
