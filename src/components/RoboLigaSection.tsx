...
const RoboLigaSection = () => {
  return <section className="min-h-[600px] flex flex-col justify-center py-8 md:py-12 px-6 md:px-8 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
